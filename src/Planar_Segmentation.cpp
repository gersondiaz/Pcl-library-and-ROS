...
public:
    cloudHandler()
    {
        pcl_sub = nh.subscribe("Nube_submuestreada", 10, &cloudHandler::cloudCB, this);
    ...
    void cloudCB(const sensor_msgs::PointCloud2 &input)
    {
        ...
        pcl::PointCloud<pcl::PointXYZ> cloud_restante;
        ...
        segmentation.setDistanceThreshold(0.026);    //0.019  0.025 menor se aleja del moldo, mayor sub acerca 
