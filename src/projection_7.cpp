...
public:
    cloudHandler()
    {
        pcl_sub = nh.subscribe("pcl_projected_6", 10, &cloudHandler::cloudCB, this);
        pcl_pub = nh.advertise<sensor_msgs::PointCloud2>("pcl_projected_7", 1);
    }
    ...
    //Create a set of planar coefficients with X=Y=0,Z=1
       ...
       coefficients->values[3] = -0.7740;   //eje z para poder hacer la  proyección
...
{
    ros::init(argc, argv, "Projecting_7");
